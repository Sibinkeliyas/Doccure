...
function Doctor_body() {
	...
	const bookNow = () => {
		navigate('/doctor-appointment-shedule')
	}
  ...
  return (
   <>
     <div className="serch-doctor-and-book ">
			<div className="search-doctor ms-4 mb-5">
				{/* <!-- Search Filter --> */}
			...
			<div className="doctor-details-in-right-side">
			{
				...
				doctorData.map((data) => {
					return(
						<div className="doctor-details-images-speciality ms-5 mt-5 mb-5 me-4">
				<div className="left-part">
					<div className="img-and-details">
						<img src={data?data?.profile!==undefined ? data.profile : require('../../../assets/img/doctors/doctor-01.jpg') :''} className="ms-3 mt-3" alt="" />
						<div className='ms-3 mt-3'>
							...
							<p className="education">
								{
									data.education.length !==0 ? data.education : "Not given"
								}
							</p>
							...
							<div className=''>
                                <AiFillStar className='star me-auto' style={{color:'gold'}} />
				...
				<div className="righ-part">
					...
					<div className="button-view-profiel mt-4 me-5">
						...
						<Button className='mt-3 mb-3' onClick={bookNow}>Book now</Button>
					</div>
				</div>
			</div>
					)
